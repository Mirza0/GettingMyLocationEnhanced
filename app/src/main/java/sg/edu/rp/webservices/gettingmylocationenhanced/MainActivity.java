...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ActivityCompat.requestPermissions(MainActivity.this,
                new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE,Manifest.permission.READ_EXTERNAL_STORAGE,Manifest.permission.MANAGE_EXTERNAL_STORAGE}, 0);
        ...
        folderLocation = getFilesDir().getAbsolutePath() + "/Downloads";
        ...
        mapFragment.getMapAsync(new OnMapReadyCallback(){
            ...
            public void onMapReady(GoogleMap googleMap) {
                ...
                LatLng poi_Singapore = new LatLng(1.4348883, 108.9833633);
            ...
            public void onLocationResult(LocationResult locationResult) {
                if (locationResult != null) {
                    ...
                    Marker north = map.addMarker(new
                            ...
                            .position(poi)
                            .title("HQ North")
                            .snippet("Block 300, Woodlands Ave 3, 123456\n" +
                                    "Tel:65433456\n")
